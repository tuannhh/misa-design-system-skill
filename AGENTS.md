...
- **Icon: chỉ dùng SVG đóng gói sẵn trong `assets/icons/`** — tra bảng hành động → icon tại `references/components/icons-map.md`. KHÔNG search icon trên internet, không dùng bộ icon khác.
