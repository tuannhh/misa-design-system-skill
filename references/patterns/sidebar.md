...
- Ở chế độ **thu gọn**, sidebar là một rail hẹp màu trắng: mỗi item chỉ còn icon 20px nằm giữa một vùng click vuông 32–36px, có bo góc; không hiển thị label trong rail.
